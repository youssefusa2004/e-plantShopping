                            ...
                            <div className="product-list">
                                {category.plants.map((plant, plantIndex) => (
                                    <div className="product-card" key={plantIndex}>
                                        ...
                                        <button
                                            className={`product-button ${addedToCart[plant.name] || (cartItems.find(item => item.name === plant.name)) ? "added-to-cart" : ""}`}
                                            onClick={() => handleAddToCart(plant)}
                                            disabled={addedToCart[plant.name] || (cartItems.find(item => item.name === plant.name))}
                                        >
